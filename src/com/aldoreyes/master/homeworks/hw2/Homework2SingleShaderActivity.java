...
public class Homework2SingleShaderActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mGLView = new GenericSurfaceView(this, renderer = new Homework2SingleRenderer(this.getApplicationContext(), mShader, R.raw.teapot, R.raw.itesm));
